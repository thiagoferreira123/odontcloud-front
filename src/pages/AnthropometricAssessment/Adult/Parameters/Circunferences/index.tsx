...
import { AdultAntropometricData } from '../../../../../types/AntropometricAssessment';
  ...
  const handleUpdateData = () => {
    try {
      ...
      const payload: Partial<AdultAntropometricData> = {
        ...
        punho_esquerdo: left_fist.toString(),
        punho_direito: right_fist.toString(),

        braco_relaxado_direito: right_relaxed_arm.toString(),
        braco_relaxado_esquerdo: left_relaxed_arm.toString(),
        braco_contraido_direito: right_contracted_arm.toString(),
        braco_contraido_esquerdo: left_contracted_arm.toString(),

        antebraco_esquerdo: forearm_left.toString(),
        antebraco_direito: forearm_right.toString(),

        coxa_proximal_direita: right_proximal_thigh.toString(),
        coxa_proximal_esquerda: left_proximal_thigh.toString(),
        coxa_medial_direita: right_medial_thigh.toString(),
        coxa_medial_esquerda: left_medial_thigh.toString(),
        coxa_distal_direita: right_distal_thigh.toString(),
        coxa_distal_esquerda: left_distal_thigh.toString(),

        panturrilha_direita: right_calf.toString(),
        panturrilha_esquerda: left_calf.toString(),
      }
