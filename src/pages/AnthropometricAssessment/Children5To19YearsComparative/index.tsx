...
const AnthropometricAssessment0a5years = () => {
  ...
  const [selectedAssessments, setSelectedAssessments] = useState<Array<AntropometricAssessmentHistory<Child5to19AntropometricData> | null>>([
    null,
    null,
    null,
    null,
              ...
              <tbody>
                {classificationMeasurements.map((measurement) => {
                  if (
                    ...
                    !(Number(selectedAssessments[0]?.data?.diametroEstiloUlnar) && Number(selectedAssessments[0]?.data?.diametroBicondioFemural))
                  ) {
                    return null;
                  } else if (
                    fieldsFatWeigth.includes(measurement.nome) &&
                    Number(selectedAssessments[0]?.data?.diametroEstiloUlnar) &&
                    Number(selectedAssessments[0]?.data?.diametroBicondioFemural)
                  ) {
                    return null;
                  }
