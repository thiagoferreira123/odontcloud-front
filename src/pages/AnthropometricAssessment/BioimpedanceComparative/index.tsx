...
import { bioimpedanceData, classificationMeasurements, girthMeasurements } from './constants';
...
const AnthropometricAssessmentPregnant = () => {
  ...
  const [selectedAssessments, setSelectedAssessments] = useState<Array<AntropometricAssessmentHistory<BioimpedanceAntropometricData> | null>>([
    null,
    null,
    null,
    null,
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      downloadPDF(data, 'compoarativo-antropometrias-bioimpedancia-' + id);
  ...
  const result = useQuery({ queryKey: ['antropometric-bioimpedance-ssessment', id], queryFn: getAssessments_, enabled: !!id });
        ...
        <Col lg="12">
          <Card body className="mb-5 mt-5">
            <Table striped>
              ...
              <tbody>
                {bioimpedanceData.map((measurement) => {
                  if (
                    !Number(
