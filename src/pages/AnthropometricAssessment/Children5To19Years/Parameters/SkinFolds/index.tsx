...
import { BodyCompositionMethod, getRequiredMeasures } from '../../Results/helpers/BodyDensityEquation';
  ...
  const handleUpdateData = () => {
    try {
      updateData(apiAssessmentDataUrl, {
        ...
        axilarMedia: parseFloatNumber(axilarMedia).toString(),
        ...
        panturrilhaMedia: parseFloatNumber(panturrilha).toString(),
      });
    } catch (error) {
      console.error(error);
    }
