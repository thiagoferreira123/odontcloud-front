...
const ChartBMI2a5Mas = () => {
  ...
  const P3Data = useMemo(
    () => [
      13.9, 13.9, 13.8, 13.8, 13.8, 13.7, 13.7, 13.7, 13.6, 13.6, 13.5, 13.5, 13.5, 13.5, 13.4, 13.4, 13.4, 13.3, 13.3, 13.3, 13.3, 13.3, 13.2, 13.2, 13.2,
      13.2, 13.2, 13.2, 13.2, 13.2, 13.1, 13.1, 13.1, 13.1, 13.1, 13.1, 13.0,
    ],
    []
  );
  const P15Data = useMemo(
    () => [
      14.8, 14.8, 14.7, 14.7, 14.7, 14.6, 14.6, 14.5, 14.5, 14.5, 14.4, 14.4, 14.4, 14.4, 14.3, 14.3, 14.3, 14.2, 14.2, 14.2, 14.2, 14.2, 14.2, 14.1, 14.1,
      14.1, 14.1, 14.1, 14.1, 14.1, 14.0, 14.0, 14.0, 14.0, 14.0, 14.0, 14.0,
    ],
    []
  );
  const P50Data = useMemo(
    () => [
      16.0, 16.0, 15.9, 15.9, 15.9, 15.8, 15.8, 15.8, 15.7, 15.7, 15.7, 15.6, 15.6, 15.6, 15.5, 15.5, 15.5, 15.5, 15.4, 15.4, 15.4, 15.4, 15.4, 15.4, 15.3,
      15.3, 15.3, 15.3, 15.3, 15.3, 15.3, 15.3, 15.3, 15.3, 15.3, 15.3, 15.2,
    ],
    []
  );
  const P85Data = useMemo(
    () => [
      17.4, 17.4, 17.3, 17.3, 17.2, 17.2, 17.2, 17.1, 17.1, 17.0, 17.0, 17.0, 17.0, 16.9, 16.9, 16.9, 16.8, 16.8, 16.8, 16.8, 16.8, 16.8, 16.8, 16.8, 16.8,
  ...
  const P97Data = useMemo(
    () => [
      18.7, 18.6, 18.6, 18.5, 18.5, 18.4, 18.4, 18.4, 18.3, 18.3, 18.2, 18.2, 18.2, 18.1, 18.1, 18.1, 18.1, 18.0, 18.0, 18.0, 18.0, 18.0, 18.0, 18.0, 18.0,
      18.0, 18.0, 18.0, 18.0, 18.0, 18.0, 18.0, 18.0, 18.0, 18.1, 18.1, 18.1,
    ],
    []
  );
...
export default React.memo(ChartBMI2a5Mas);
