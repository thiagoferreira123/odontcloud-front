import { Child0to5AntropometricData, AntropometricAssessmentHistory } from "/src/types/AntropometricAssessment";
...
interface ModalSendPDFStore {
  ...
  // eslint-disable-next-line no-unused-vars
  handleShowModal: (selectedAssessments: Array<AntropometricAssessmentHistory<Child0to5AntropometricData> | null>) => void;
}
