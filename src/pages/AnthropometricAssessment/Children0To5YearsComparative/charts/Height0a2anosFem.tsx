...
interface Height0a2anosFemaleProps {
  selectedAssessments: (AntropometricAssessmentHistory<Child0to5AntropometricData> | null)[];
}

const Height0a2anosFem = ({ selectedAssessments }: Height0a2anosFemaleProps) => {
  ...
  }, [P15Data, P3Data, P50Data, P85Data, P97Data, selectedAssessments, months]);
