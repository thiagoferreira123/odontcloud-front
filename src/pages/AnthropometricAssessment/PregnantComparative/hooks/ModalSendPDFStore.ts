import { PregnantAntropometricData, AntropometricAssessmentHistory } from "/src/types/AntropometricAssessment";
...
interface ModalSendPDFStore {
  ...
  // eslint-disable-next-line no-unused-vars
  handleShowModal: (selectedAssessments: Array<AntropometricAssessmentHistory<PregnantAntropometricData> | null>) => void;
}
