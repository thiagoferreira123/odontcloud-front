...
export default function Material(props: MaterialProps) {
  ...
  const onClickDownloadPDF = async () => {
    ...
    try {
      ...
      if(buildShoppingList) {
        ...
        const { data } = await api.post('/plano-alimentar-equivalente-pdf/' + props.material.id + '/lista-de-compras', {
          parseToKilograms,
        }, {
          responseType: 'arraybuffer',
          headers: {
      ...
      if(buildOrientation) {
        ...
        const { data } = await api.get(
          '/plano-alimentar-equivalente-pdf/' + props.material.id + '/orientacao',
          {
            responseType: 'arraybuffer',
            headers: {
              'Content-Type': 'application/json',
      ...
      if(buildMicronutrientsResume) {
        ...
        const { data } = await api.get(
          '/plano-alimentar-equivalente-pdf/' + props.material.id + '/micronutrientes',
          {
            responseType: 'arraybuffer',
            headers: {
              'Content-Type': 'application/json',
  ...
  const onClickSendEmail = async () => {
    ...
    try {
      ...
      await api.post('/plano-alimentar-equivalente-email/' + props.material.id, payload);
