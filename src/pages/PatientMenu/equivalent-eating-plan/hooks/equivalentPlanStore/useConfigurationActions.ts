...
import { createEquivalentEatingPlanStore, ConfigurationActions } from "./types";

// eslint-disable-next-line no-unused-vars
const useConfigurationActions = (set: (partial: (state: createEquivalentEatingPlanStore) => Partial<createEquivalentEatingPlanStore>) => void) => (<ConfigurationActions>{
