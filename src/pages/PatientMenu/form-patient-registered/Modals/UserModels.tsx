import { useUserFormModelsQuery } from '../hooks/queries';
...
const UserModels = () => {
  ...
  const { data = [], isError, isFetching } = useUserFormModelsQuery();
  ...
  if (isEmpty) {
    return <Empty message="Não há modelos criados pelo usuário"></Empty>;
  }
  return (
    <>
      {isFetching ? (
