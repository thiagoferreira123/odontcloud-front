...
export default function ManipuledFormulas({ materials, index }: MaterialItemProps) {
  return (
    <Row className="g-0">
      ...
      <Col className="mb-2">
        <Card className="h-100">
          <Card.Body className="d-flex flex-column justify-content-start">
            {materials
              .filter((material) => material.material === 'formulas_manipuladas')
              .map((material) => (
