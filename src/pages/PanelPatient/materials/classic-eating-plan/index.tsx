...
import { ClassicEatingPlanMaterials, MaterialItemProps, MaterialOptions, SendingMaterial } from '../../../../types/SendingMaterial';
import * as Icon from 'react-bootstrap-icons';

export default function ClassicEatingPlans({ materials, index }: MaterialItemProps) {
  return (
      ...
      <Col className="mb-2">
        <Card className="h-100">
          <Card.Body className="d-flex flex-column justify-content-start">
            {materials
              .filter((material) => material.material === 'plano_alimentar')
              .map((material) => (
                <Material key={material.tabela + material.id} material={material as SendingMaterial<ClassicEatingPlanMaterials>} />
              ))}
          </Card.Body>
        </Card>
      </Col>
