...
import { MaterialItemProps } from '../../../../types/SendingMaterial';

export default function QualitativeEatingPlans({ materials, index }: MaterialItemProps) {
  return (
    <Row className="g-0">
      ...
      <Col className="mb-2">
        <Card className="h-100">
          <Card.Body className="d-flex flex-column justify-content-start">
            {materials
              .filter((material) => material.material === 'plano_qualitativo')
              .map((material) => (
