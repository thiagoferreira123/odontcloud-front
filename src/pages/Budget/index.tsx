    ...
    <>
      ...
      <Card body className="mb-2 mt-3">
        ...
        <h5 className="mt-4 text-center">
          {' '}
          O valor total do orçamento é de <strong>{parseToBrValue(valueWithDiscount)}</strong> com um desconto de <strong>{discountValue}</strong> já aplicado. Será parcelado em{' '}
          <strong>{installments}x de {installmentValue} R$ </strong>
        </h5>
      </Card>
