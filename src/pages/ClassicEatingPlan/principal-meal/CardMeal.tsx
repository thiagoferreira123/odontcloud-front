...
interface CardMealProps {
  ...
  handleOpenModalFavoritedFood: (meal: ClassicPlanMeal) => void;
}
...
const CardMeal = (props: CardMealProps) => {
  ...
  const handleDuplicateMeal = async () => {
    ...
    try {
      ...
      updateNotify(toastId.current, 'Refeição duplicada com sucesso!', 'Sucesso', 'check', 'success');
    } catch (error) {
      updateNotify(toastId.current, 'Erro ao duplicar refeição!', 'Erro', 'close', 'danger');
      console.error(error);
    }
  };
                ...
                <div>
                  ...
                  <Dropdown as={ButtonGroup} autoClose={true}>
                    ...
                    <Dropdown.Menu>
                      ...
                      <Dropdown.Item onClick={() => props.handleOpenModalFavoritedFood(props.meal)}>
                        <CsLineIcons icon="star" /> Salvar refeição como modelo
                      </Dropdown.Item>
            ...
            <div>
              <div className={props.meal.tipoTexto === 'SIM' ? 'd-none' : ''}>
                ...
                <ReactSortable
                  ...
                  onChange={() => setTimeout(() => setSortableEnabled(true), 500)}
                  animation={300}
                >
