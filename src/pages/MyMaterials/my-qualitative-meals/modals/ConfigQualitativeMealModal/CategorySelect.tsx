...
import { QualitativeMeal, useMyQualitativeMealsStore } from '../../hooks/MyQualitativeMeals';
...
const CategorySelect = (props: SelectCategoryProps) => {
  ...
  const qualitativeMeals = useMyQualitativeMealsStore((state) => state.qualitativeMeals);

  const onSuggestionsFetchRequested = ({ value }: { value: string }) => {
    setSuggestions(getSuggestions(qualitativeMeals ?? [], value));
  };
  ...
  const getSuggestions = (templates: QualitativeMeal[], value: string) => {
