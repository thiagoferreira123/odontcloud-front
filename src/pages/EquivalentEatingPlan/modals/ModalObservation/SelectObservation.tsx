...
const SelectObservation = (props: SelectObservationProps) => {
  ...
  useEffect(() => {
    setOptions(orientationsResult.data?.map((orientation: OrientationTemplate) => ({ label: orientation.nome, value: String(orientation.orientacao) })) ?? []);
