...
import { ClassicPlanReplacementMealFood } from '/src/types/PlanoAlimentarClassico';
...
const Food = (props: FoodProps) => {
  const { updateReplacementMealFood, removeReplacementMealFood } = useClassicPlan();
    ...
    <div>
      ...
      <div>
        <Button
          ...
          size="sm"
          className={`mt-1 ms-4 outline-primary ${props.food.alimentoequivalentes && props.food.alimentoequivalentes.length ? '' : 'd-none'}`}
        >
