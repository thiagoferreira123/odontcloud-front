...
import { ClassicPlanReplacementMeal, ClassicPlanReplacementMealFood } from '/src/types/PlanoAlimentarClassico';
...
const CardMeal = (props: CardMealProps) => {
  ...
  const { setBaseMealId, setSelectedReplacementMeal, setShowModalDeleteMeal } = useModalsStore();
