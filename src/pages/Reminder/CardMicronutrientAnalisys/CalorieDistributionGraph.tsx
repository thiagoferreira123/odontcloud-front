...
const CalorieDistributionGraph = (props: CalorieDistributionGraphProps) => {
  ...
  const [tollTipIcon, setToolTipIcon] = useState('burger');

  const { carbohydrate, fat, protein } = useMacroNutrientsMath();
  ...
  }, [carbohydrate, fat, props.meals, protein]);
  ...
  }, [carbohydrate, fat, props.meals, protein, themeValues.quaternary, themeValues.quaternaryrgb, themeValues.secondary, themeValues.secondaryrgb, themeValues.warning, themeValues.warningrgb]);
