...
import { LAYOUT, MENU_BEHAVIOUR, MENU_PLACEMENT, NAV_COLOR, RADIUS, THEME_COLOR } from '/src/constants';
import { menuChangeBehaviour, menuChangePlacement } from '/src/layout/nav/main-menu/menuSlice';
import { settingsChangeColor, settingsChangeLayout, settingsChangeNavColor, settingsChangeRadius } from '/src/settings/settingsSlice';
...
const SettingsModal = ({ handleClose, show = false }) => {
  ...
  return (
    <>
      ...
      >
        <Modal.Header>
          <Modal.Title as="h5">Selecione sua cor preferida</Modal.Title>
          <button type="button" className="btn-close" onClick={handleClose} />
        </Modal.Header>
        <Modal.Body>
          <OverlayScrollbarsComponent options={{ overflowBehavior: { x: 'hidden', y: 'scroll' } }} className="scroll-track-visible">
            <OptionGroup label="Cores disponíveis" noContainer>
              <>
            ...
            <OptionGroup label="Barra de navegação">
              <>
                <OptionItem
                  label="HORIZONTAL"
