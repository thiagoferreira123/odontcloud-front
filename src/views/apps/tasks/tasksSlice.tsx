...
export const getTasks = () => async (dispatch) => {
  ...
  const response = await axios.get(`${SERVICE_URL}/ferramentas/tasks`);
...
export const createTask =
  ...
  async (dispatch) => {
    ...
    const response = await axios.post(`${SERVICE_URL}/ferramentas/tasks`, { item });
    const tasks = response.data;
    dispatch(receiveService({ tasks, loading: false }));
  };
...
export const updateTask =
  ...
  async (dispatch) => {
    dispatch(setLoading(true));
    const response = await axios.put(`${SERVICE_URL}/ferramentas/tasks`, { item });
    const tasks = response.data;
    dispatch(receiveService({ tasks, loading: false }));
  };
export const deleteTask =
  ({ id }) =>
  async (dispatch) => {
    const response = await axios.delete(`${SERVICE_URL}/ferramentas/tasks`, { id });
    const tasks = response.data;
    dispatch(receiveService({ tasks, loading: false }));
  };
