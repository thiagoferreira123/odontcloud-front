...
const ContextMenuDoubleClick = () => {
  ...
  return (
    <>
      <div onDoubleClickCapture={(e) => displayContextMenu(e, 'context-menu-double-click')}>
        <Card className="mb-5 cursor-default disable-text-selection">
          <Row className="sh-9 p-card pt-0 pb-0 g-0">
            <Col xs="2" className="d-flex align-items-center justify-content-center">
              <div className="pe-card">
                <CsLineIcons icon="grid-2" width="20" height="20" className="cs-icon icon text-primary" />
              </div>
            </Col>
            <Col xs="10" className="d-flex flex-column justify-content-center">
              <p className="heading mb-0">Double Click Trigger</p>
