...
import csInterfaceIcons from './data/cs-interface-icons-tags';

const CsInterfaceIconsPage = () => {
  const title = 'CS Line Interface Icons';
  const description = 'An essential and smaller version of CS Line icons in font format.';
  ...
  const [data, setData] = useState(csInterfaceIcons);
  const [value, setValue] = useState('');
  const fuse = new Fuse(csInterfaceIcons, {
    shouldSort: true,
...
export default CsInterfaceIconsPage;
