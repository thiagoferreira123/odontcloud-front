...
import CheckAll from '/src/components/check-all/CheckAll';
          ...
          <Card className={`${selectedItems.includes(1) && 'selected'}`} onClick={() => checkItem(1)}>
            <Row className="g-0 h-auto sh-sm-19">
              <Col xs="12" sm="auto" className="h-100">
                <img src="/img/laminas/99490fa5-4ea4-4f0f-92fa-3be6e2d6e2b3.png" alt="user" className="card-img card-img-horizontal-sm sh-22 h-sm-100 sw-sm-16 sw-lg-19" />
              </Col>
