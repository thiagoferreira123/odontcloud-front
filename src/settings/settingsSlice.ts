...
const getComputedValues = () => {
  ...
  return {
    ...
    darkText: rootStyle.getPropertyValue('--dark-text').trim(),
    ...
    dangerrgb: rootStyle.getPropertyValue('--danger-rgb').trim(),
    inforgb: rootStyle.getPropertyValue('--info-rgb').trim(),
    warningrgb: rootStyle.getPropertyValue('--warning-rgb').trim(),
    successrgb: rootStyle.getPropertyValue('--success-rgb').trim(),
    lightrgb: rootStyle.getPropertyValue('--light-rgb').trim(),
    darkrgb: rootStyle.getPropertyValue('--dark-rgb').trim(),
    bodyrgb: rootStyle.getPropertyValue('--body-rgb').trim(),
...
export const settingsChangeColor = (color: string) => async (dispatch: (fn: unknown) => void) => {
