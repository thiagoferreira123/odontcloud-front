const enMessages = {
  ...
  'menu.apps': 'Ferramentas',
  'menu.calendar': 'Agenda',
  'menu.chat': 'Chat',
  'menu.contacts': 'Contacts',
  'menu.mailbox': 'Mailbox',
  'menu.tasks': 'Tasks',
  'menu.consultorio': 'Consultório',
  'menu.financeiro': 'Controle financeiro',
  ...
  'menu.plano-alimentar-classico': 'Classic Meal Plan',
  'menu.plano-alimentar-equivalente': 'Equivalent Meal Plan',
  'menu.diario-alimentar': 'Diário alimentar',
  'menu.controle-pacientes': 'Controle de pacientes',
  'menu.rastreamento-metabolico-avulso': 'Rastreamento metabólico pré-consulta',
  'menu.forum': 'Fórum de discussões',
  'menu.formulario-pre-consulta': 'Formulários pré-consulta',
  'menu.formulario-pre-consulta-preencher': 'Formulários pré-consulta (preencher)',
  'menu.meus-materiais': 'Cadastrar materiais para usar com pacientes',
